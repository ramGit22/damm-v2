...
use crate::{
    constants::SCALE_OFFSET, state::Pool, u128x128_math::Rounding, utils_math::safe_shl_div_cast,
};
...
proptest! {
    ...
    fn test_calculate_reward_rate(funding_amount in 1..=U64_MAX) {
        ...
        let expect_rate: u128 = safe_shl_div_cast(funding_amount.into(), reward_info.reward_duration.into(), SCALE_OFFSET, Rounding::Down)?;
